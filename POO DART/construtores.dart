...
void main() {
  ...
  print('Data com valor padrão $semValor'); // Retorno padrão do construtor com parâmetro opcional
  print(Data()); // Retorno padrão direto no print
  print(Data(20)); // Retorno padrão adicionando um valor e o resto padrão
  print(Data(20, 12)); // Retorno padrão adicionando dois valores e o resto padrão
